...
//        setButtons()
    ...
    func createData() -> [StepperData]{
        steps.append(StepperData(stepId: 1, date: "", status: "Enter your username", stepComplete: true))
        steps.append(StepperData(stepId: 2, date: "", status: "Enter your card number & PIN", stepComplete: false))
        steps.append(StepperData(stepId: 3, date: "", status: "Enter new password", stepComplete: false))
         return steps
